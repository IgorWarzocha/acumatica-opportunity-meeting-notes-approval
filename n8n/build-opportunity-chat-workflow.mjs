		...
		"nodes": [
			...
			},
			{
				"parameters": {
					...
					"needsFallback": false,
					"options": {
						"systemMessage": "You answer questions about CRM opportunities. Available tools: get_opportunity_context returns current opportunity fields; get_related_meeting_notes returns related meeting-note approval records and transcript projections. Use tools when current Acumatica data or related meeting notes are needed. Answer directly and concisely.",
						"maxIterations": 4,
